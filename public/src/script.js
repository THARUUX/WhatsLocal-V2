...
if (typeof window !== "undefined") {
    ...
    console.log("This code is running on the server, not in the browser.");
}
...
// Listen for QR updates from the server
socket.on("qrUpdate", ({ qrAvailable }) => {
    if (qrAvailable) {
        updateQr();
    }
});
...
function updateQr() {
    document.getElementById("qr-code").src = "/qr/latest"; 
    document.getElementById("qr-container").style.display = "flex";
    document.getElementById("main").style.display = "none";
}

// Function to show main content when connected
function stayConnected() {
    document.getElementById("qr-container").style.display = "none";
    document.getElementById("main").style.display = "flex";
}

// Expose functions to global scope (useful for debugging in console)
window.updateQr = updateQr;
window.stayConnected = stayConnected;
